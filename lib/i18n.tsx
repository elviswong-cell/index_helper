...
export const dict: Dict = {
  ...
  status_full: { en: "Full", zh: "已額滿" },
  slots_left_suffix: { en: "left", zh: "個名額尚餘" },
  slots_filled_suffix: { en: "slots filled", zh: "個名額已滿" },
  pending_applications: { en: "waiting for review", zh: "個報名待審批" },
  ...
  select_lessons_hint: {
    en: "Tick the MT and/or TA box on every date you're available for — the admin can accept some and decline others.",
    zh: "喺你有空嘅日期勾選 MT 或 TA（可兩者都揀）。管理員可以只接受其中部分。",
  },
  select_all: { en: "Select all", zh: "全選" },
  clear_all: { en: "Clear", zh: "清除" },
  select_lesson_required: {
    en: "Please select at least one lesson and role",
    zh: "請至少選擇一堂課的一個職位",
  },
  slot_count_suffix: { en: "slots", zh: "個名額" },
  full_lesson_locked_hint: {
    en: "Full slots can't be selected, and “—” means that lesson isn't hiring that role.",
    zh: "已額滿的名額無法選擇；「—」代表該堂不招聘此職位。",
  },
  ...
  slots_confirmed_suffix: { en: "slots accepted", zh: "個名額已確認" },
  total_slots_suffix: { en: "slots in total", zh: "個名額" },
  ...
  form_slots_per_lesson_hint: {
    en: "Rates apply to every lesson. Slots are set per lesson in the table above — put 0 in a column for a lesson that doesn't need that role.",
    zh: "薪資適用於所有堂數。名額喺上面表格逐堂設定 — 唔需要嗰個職位就填 0。",
  },
  form_fill_column: { en: "same for all", zh: "全部相同" },
  form_error_no_slots: {
    en: "needs at least one MT or TA slot",
    zh: "至少要有一個 MT 或 TA 名額",
  },
